...
using Tumin.Data;
using Tumin.Models;
using Tumin.Models.AccountViewModels;
...
namespace Tumin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.RedirectCreate = "Register";
            if(id=="Admin") ViewBag.RedirectCreate = "RegisterAdmin";
            if (id == "Bussinesss") ViewBag.RedirectCreate = "RegisterBussinesss";

            var allusers = await _userManager.GetUsersInRoleAsync(id);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register(RegisterWithUserInfo model, string returnUrl = null)
        {
            ViewData["action"] = "Register";
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
        ...
        [Authorize(Roles = "Admin")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RegisterAdmin(RegisterWithUserInfo model, string returnUrl = null)
        {
            ViewData["action"] = "RegisterAdmin";
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
        ...
        public async  Task<IdentityResult> CreateUserByRole(RegisterWithUserInfo model, string Role)
        {
            ...
            if (result.Succeeded)
            {
                ...
                model.UserInformation.UserId = new Guid(user.Id);
                _context.UserInformation.Add(model.UserInformation);
        ...
        public async Task<IActionResult> DeleteUser(string Id)
        {
           var user= await _userManager.FindByIdAsync(Id);
            ...
            if (user != null) { 
                ...
                var userInfo = _context.UserInformation.Find(new Guid(Id));
                if (userInfo!= null)
                {                
